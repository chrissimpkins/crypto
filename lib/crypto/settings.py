...
ABOUT
  crypto provides a simple interface to the Gnu Privacy Guard (gpg) application for symmetric encryption of one or more files.  gpg must be installed on your system in order to use crypto.
...
DESCRIPTION
  ...
  Encryption is performed with the AES256 cipher.
"""
